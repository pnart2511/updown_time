  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
        <h1 className="text-xl font-bold text-[#1D3557] mb-6">Đăng nhập</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between mb-1.5">
              ...
              <Link href="/forgot-password" className="text-xs text-[#F6821F] hover:underline">
                Quên mật khẩu?
              </Link>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-10 rounded-lg bg-[#F6821F] hover:bg-[#e0721a] text-white font-semibold text-sm transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
          >
            {loading ? (
      ...
      <p className="text-sm text-gray-500 mt-6">
        Chưa có tài khoản?{" "}
        <Link href="/register" className="text-[#F6821F] font-semibold hover:underline">
          Đăng ký miễn phí
        </Link>
      </p>
    </div>
